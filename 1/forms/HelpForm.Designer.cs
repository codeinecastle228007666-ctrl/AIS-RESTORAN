namespace _1.forms
{
    ...
    "Формула:\r\n" +
    "  Базовая ЗП = (Оклад / Норма_дней) * Отработано_дней\r\n" +
    "  Итого = Базовая ЗП + Премия – Удержания\r\n\r\n" +
    "Норма дней по умолчанию = 21.\r\n" +
    "Оклад берётся из справочника должностей сотрудника.\r\n" +
    "Пользователь вводит количество отработанных дней, премию и удержания.\r\n" +
