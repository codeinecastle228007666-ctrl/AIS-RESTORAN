...
namespace _1.forms
{
    // Форма создания заказа: выбор клиента, стола, сотрудника. Вызывает процедуру sp_create_zakaz для создания заказа в БД.
    public partial class redzakazaform : Form
    {
        ...
        // Открыть визуальный план зала для выбора стола.
        private void buttonSelectTable_Click(object sender, EventArgs e)
        {
            ...
            {
                comboBoxStol.SelectedValue = zal.SelectedTableId;
            }
        }

        // Создать заказ через процедуру sp_create_zakaz.
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Пожалуйста, заполните клиента, стол и сотрудника.");
                return;
            }
