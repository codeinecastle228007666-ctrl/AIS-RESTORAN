...
{
    // Форма просмотра и редактирования состава заказа (добавление/удаление блюд). Блокируется после оплаты заказа.
    public partial class zakazi_itemsForm : Form
    {
        ...
        private void zakazi_itemsForm_Load(object sender, EventArgs e)
        {
            ...
            if (_oplacheno)
            {
                MessageBox.Show("Заказ уже оплачен! Редактирование состава недоступно.");
        ...
        // Загрузка состава заказа: блюдо, количество, цена, сумма.
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string dishName = dataGridView1.CurrentRow.Cells["Блюдо"].Value?.ToString() ?? "";
            if (MessageBox.Show($"Удалить блюдо \"{dishName}\" из заказа?", "Подтверждение",
