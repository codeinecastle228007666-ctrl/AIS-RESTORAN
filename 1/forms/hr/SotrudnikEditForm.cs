...
namespace _1.forms
{
    ...
    public partial class SotrudnikEditForm : Form
    {
        ...
        // Привязка обработчиков ограничения ввода к полям.
        ...
        private void LoadData()
        {
            ...
            // Дата рождения может быть DateOnly или DateTime в зависимости от версии PostgreSQL
        ...
        // Сохранение сотрудника (добавление или обновление в транзакции).
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (_sotrudnikId == -1)
                {
                    // Добавление нового сотрудника (restoran_id = 1 фиксирован)
                    string sql = @"
        ...
        // Ограничение ввода: только буквы, пробел, дефис, точка.
        ...
        // Ограничение ввода: только цифры (для паспортных данных).
