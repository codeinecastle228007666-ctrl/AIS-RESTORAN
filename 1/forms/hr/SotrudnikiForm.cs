// Класс управления сотрудниками (CRUD + создание учётных записей + зарплата)
using _1.data;
using Npgsql;
using System;
using System.Data;
...
namespace _1.forms
{
    // Управление сотрудниками: просмотр, добавление, редактирование, удаление, создание учётных записей и расчёт зарплаты.
    public partial class SotrudnikiForm : Form
    {
        ...
        // Загрузка списка сотрудников с информацией из БД.
        ...
        // Генерация логина из ФИО: первая буква имени + фамилия (транслит).
        ...
        private void buttonCreateUser_Click(object sender, EventArgs e)
        {
            ...
            // Хеширование пароля через pgcrypto (bcrypt, cost factor 6).
            // @p — параметр, пароль не попадает в SQL-строку.
            ...
            // INSERT пользователя: все три поля через NpgsqlParameter (защита инъекций).
        ...
        // Открытие формы зарплаты для выбранного сотрудника.
