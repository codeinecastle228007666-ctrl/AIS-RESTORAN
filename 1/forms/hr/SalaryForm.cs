// Форма расчёта и отображения заработной платы сотрудника
using _1.data;
using Npgsql;
using OfficeOpenXml;
...
namespace _1.forms
{
    // Форма расчёта зарплаты сотрудника за период, учитывает оклад, премии и удержания. Экспортирует данные в Excel.
    public partial class SalaryForm : Form
    {
        ...
        // Получение оклада из БД (через join с таблицей должностей).
        // Параметр @id изолирует поле WHERE — защита от SQL-инъекций, кэширование планов запросов.
        ...
        private void buttonCalculate_Click(object sender, EventArgs e)
        {
            ...
            int normDays = 21; // норма рабочих дней в месяце (условно)
            ...
            labelResult.Text = $"Итого к выдаче: {total:N2} руб.";
        ...
        // Выгрузка расчёта зарплаты в Excel через библиотеку EPPlus.
