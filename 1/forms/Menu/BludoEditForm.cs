// ‘орма добавлени€/редактировани€ блюда
using System;
...
{
    // ‘орма создани€ или редактировани€ блюда, а также управлени€ его составом.
    public partial class BludoEditForm : Form
    {
        ...
        // «агрузка данных блюда дл€ редактировани€.
        void LoadBludo()
        {
            string sql = @"
                SELECT *
        ...
        // —охранение блюда (вставка с RETURNING или обновление).
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            if (bludoId == -1)
            {
                // ƒобавление: RETURNING bludo_id чтобы сразу получить ID
                string sql = @"
                    INSERT INTO bludo
            ...
            MessageBox.Show("Ѕлюдо сохранено");
        }
        ...
        // ќткрыть форму управлени€ составом блюда (ингредиентами).
        private void button3_Click(object sender, EventArgs e)
        {
            if (bludoId == -1)
            {
                MessageBox.Show("—начала сохраните блюдо, чтобы добавить ингредиенты.");
                return;
            }
