...
namespace _1
{
    // Справочник клиентов: просмотр, добавление, редактирование, удаление, поиск.
    public partial class Clienti : Form
    {
        ...
        // Открыть форму редактирования выбранного клиента.
        ...
        // Фильтр записей по ФИО или телефону (на стороне клиента).
