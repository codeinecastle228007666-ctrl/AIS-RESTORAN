// Форма заявки поставщику (создание, просмотр, удаление)
using System;
using System.Data;
...
{
    // Форма для создания и просмотра заявок поставщикам. Данные хранятся в виде текстовых файлов в папке zayavki/.
    // В отличие от других форм, заявки НЕ используют БД — только файловая система.
    public partial class ZayavkaPostavshiku : Form
    {
        ...
        // Сохранение новой заявки в текстовый файл.
...
Подпись: _______     Согласовано: ________
Дата создания: {DateTime.Now:dd.MM.yyyy HH:mm:ss}";
        ...
        // Открытие файла заявки в блокноте.
