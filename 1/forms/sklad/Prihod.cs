// Форма оприходования товара на склад
using _1.data;
using Npgsql;
using System;
...
{
    // Форма для оприходования товара на склад от поставщика. Вызывает процедуру prihod_producta и записывает движение.
    // Поля: товар (comboBox1), поставщик (comboBox2), количество (textBox1), цена (textBox2)
    public partial class Prihod : Form
    {
        ...
        // Оприходование товара: проверка данных и вставка в таблицы.
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Ошибка: не удалось получить ID товара");
                    return;
                }
                ...
                // Работа с русской культурой (запятая как разделитель)
                ...
                // CALL процедуры prihod_producta + INSERT в журнал движения.
                // ВСЕ значения передаются через NpgsqlParameter — защита от SQL-инъекций.
                // NpgsqlDbType.Numeric указан явно для сохранения точности Decimal.
                string sql = @"
        ...
        // Валидация ввода: только цифры и запятая.
